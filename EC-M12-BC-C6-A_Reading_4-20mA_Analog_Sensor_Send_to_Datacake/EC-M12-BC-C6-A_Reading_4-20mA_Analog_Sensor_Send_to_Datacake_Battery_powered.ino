...
// Battery-powered build: disable all debug serial output.
class NullDebugSerial : public Stream {
 public:
...
NullDebugSerial nullDebugSerial;
#define SerialMon nullDebugSerial
#define Serial nullDebugSerial
